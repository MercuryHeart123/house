  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <section
          style={{ marginRight: "3vw", minWidth: "40vw", maxWidth: "40vw" }}
        >
          <div class="mb-3">
            <input
              class="form-control"
          ...
          <form id="all-data" onSubmit={this.handleSubmit}>
            ...
            <div class="mb-3">
              ...
              <input
                ...
                class="form-control"
                name="province"
                defaultValue={this.props.post.province}
                id="exampleInputPassword1"
              />
            </div>
            <div class="mb-3">
            ...
            >
              <option value={this.props.post.status} selected disabled hidden>
                {this.props.post.status || "Select status"}
              </option>
